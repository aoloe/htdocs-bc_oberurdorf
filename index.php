...
$(document).ready(function() {
	...
	<body>
        <header>
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li><a href="javascript:void(0)">Programm</a></li>
                    <li><a href="javascript:void(0)">Spielort</a></li>
        ...
        <section class="container">
            ...
            <article class="slider_content" id="slider_content1">
                <h3>Sport, Spiel, Spass</h3>
                <p> Wir haben einfach den Plausch am Sport, möchten regelmässig spielen, aber ohne Verpflichtung, Aemter und Turniere.</p>

            </article>
            <article class="slider_content" id="slider_content2">
                <h3>Nächste Trainings</h3>
                <ul>
                <li>Freitag 22. August, 20 Uhr</li>
            ...
            <article class="slider_content" id="slider_content3">
                <h3>Sporthalle Kanti Urdorf</h3>
                <p>Kantonsschule Limmattal<br>
                 In der Luberzen 34<br>
                 Alte Turnhalle <a href="javascript:void(0)" class="responsive_button">Mehr lesen...</a></p>
                <a class="button" href="javascript:void(0)">Mehr lesen</a>
            </article>
            <div id="slides">
        ...
        <section id="spacer">  
            ...
            <p>
            <span class="date_circle"><span class="date_day">22</span><span class="date_month">Aug</span></span>
            <span class="date_text">Training</span>
            <span class="date_circle"><span class="date_day">29</span><span class="date_month">Aug</span></span>
            <span class="date_text">Training</span>
            <span class="date_circle date_circle_no"><span class="date_day">5</span><span class="date_month">Sep</span></span>
            <span class="date_text">kein Training</span>
            </p>
        </section>
...
Der Badminton-ClubOberurdorf existiert schon seit über 20 Jahren.

Wir haben einfach den Plausch am Sport, möchten regelmässig spielen, aber ohne Verpflichtung, Aemter und Turniere.

Wir sind wild gemischt, Mannen und Frauen, 20-Jährige ebenso wie Mitfünziger. 
...
Interessiert? Komm doch einfach vorbei, frage nach Rainer, Markus oder Curzio!

Kontakt

Unter News findest Du das aktuelle Jahresprogramm.
</md>
            </article>
            <section class="column2">
                ...
                <article class="row">  
                    ...
                    <img src="img/Objects-Rocket-icon.png" width="80" class="rocket" alt="Some alt text"/>
                    <p>Und wenn es nicht umgeschrieben wurde, dann benutzen Sie es immernoch.</p>
                </article> 
                <article class="row">
                	<h4 class="hidden">Ipsum</h4>                
                    <img src="img/Measurement-Units-Time-icon.png" width="80" class="clock" alt="Some alt text"/>
        ...
        <section id="boxcontent">
            ...
            <article>            	               
                <img src="img/Buzz-Private-icon.png" alt="Some alt text"/>                
                <h3>Lorem ipsum</h3>
                <p>        	
            ...
            <article>            	     
                <img src="img/Industry-Engineering-icon.png" alt="Some alt text"/>              
                <h3>Consectetuer</h3>
                <p>        	
            ...
            <article>            	    
                <img src="img/Cell-Phones-Iphone-icon.png" alt="Some alt text"/>                
